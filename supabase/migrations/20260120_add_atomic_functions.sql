...
BEGIN
  ...
  VALUES (
    ...
    ARRAY(SELECT jsonb_array_elements_text(COALESCE(p_flight_data->'operational_days', '[]'::jsonb))),
    ARRAY(SELECT jsonb_array_elements_text(COALESCE(p_flight_data->'product_types', '[]'::jsonb))),
